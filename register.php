   ...
   <form class="form-horizontal" method="post" action="user_cad.php" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" id="inputEmail3" name="nascimento" placeholder="DD/MM/AAAA" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="(xx) xxxx-xxxx" name="telefone"required>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="(xx) xxxxx-xxxx" name="telefone"required>
                  </div>
                </div>
